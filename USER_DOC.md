...
- MariaDB: Database
- Static website: Seperate simple site (port 8000)
...
Then confirm by visiting the site (https://makkach.42.fr), Adminer (http://localhost:9999), and the static site (http://localhost:8000) in a browser.